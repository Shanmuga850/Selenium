...
public class UserCredentialsExcel {
	...
	public ArrayList<String> getdata(String testcaseName) throws IOException
	{
		...
		//FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+"//src//test//java//pearl//SmartER//Data//Browser_names.xlsx");		
		  FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+"//src//test//java//pearl//SmartER//Utils//User Credentials.xlsx");
		...
		for(int i=0;i<sheets;i++)
		{
				...
				
			{
				...
				while(cells.hasNext())
				{
					...
					if(value.getStringCellValue().equalsIgnoreCase("UserCredentials")) // Testcases
					{
						column=k;
